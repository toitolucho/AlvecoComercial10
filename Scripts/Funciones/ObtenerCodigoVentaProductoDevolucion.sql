...
DROP FUNCTION ObtenerCodigoVentaProductoDevolucion
GO

CREATE FUNCTION ObtenerCodigoVentaProductoDevolucion()
RETURNS CHAR(12)
...
BEGIN
	...
	FROM VentasProductosDevoluciones CP
	WHERE DATEPART(MONTH,CP.FechaHoraDevolucion ) = DATEPART(MONTH, GETDATE())
